package libraryManager.security;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        try {
            ...
            // Sửa lại chỗ này dùng log của Lombok
            log.error("Không thể thiết lập xác thực người dùng", ex);
        }

        // Dòng này cực kỳ quan trọng: Cho phép request đi tiếp dù có token hay không
        // Nếu không có dòng này, trang /login sẽ bị treo hoặc lỗi
        filterChain.doFilter(request, response);
    }
